    ...
    class Component < Satis::ApplicationComponent
      ...
      def view_menu(view_id)
        Satis::Menus::Builder.build(:view_menu) do |m|
          ...
          m.item :rename, icon: 'fa-light fa-pen', link: nil, link_attributes: { data: { reflex: "click->ActionTable::FilterReflex#rename_label_to_text", 'reflex-serialize-form': "true", table: params[:table], view_id: view_id} }
