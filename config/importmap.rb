...
pin_all_from Satis::Engine.root.join("app/javascript/satis/controllers"), under: "controllers", to: "satis/controllers"
pin_all_from Satis::Engine.root.join("app/javascript/satis/utility_controllers"), under: "utility_controllers", to: "satis/utility_controllers"
